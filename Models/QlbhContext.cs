...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=QLBH;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Chitietphieudathang>(entity =>
        {
            ...
            entity.HasOne(d => d.MapdhNavigation).WithMany(p => p.Chitietphieudathangs)
        ...
        modelBuilder.Entity<Chitietphieugiaohang>(entity =>
        {
            ...
            entity.HasOne(d => d.MapghNavigation).WithMany(p => p.Chitietphieugiaohangs)
        ...
        modelBuilder.Entity<Hanghoa>(entity =>
        {
            ...
            entity.HasOne(d => d.MansxNavigation).WithMany(p => p.Hanghoas)
        ...
        modelBuilder.Entity<Phieudathang>(entity =>
        {
            ...
            entity.HasOne(d => d.MakhNavigation).WithMany(p => p.Phieudathangs)
